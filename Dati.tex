...
\newcommand{\nomeTutorAziendale}{Salvatore}
\newcommand{\cognomeTutorAziendale}{Dore}
\newcommand{\emailTutorAziendale}{s.dore@synclab.it}
\newcommand{\telTutorAziendale}{+ 39 000 00 00 000}
\newcommand{\ruoloTutorAziendale}{Responsabile area EAI}
...
\newcommand{\prospettoSettimanale}{
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item Incontro con le persone c
            oinvolte nel progetto per discutere i requisiti e le richieste relative al sistema da sviluppare;
